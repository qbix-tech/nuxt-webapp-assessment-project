...
Once you have completed all the tasks, create a **private repository** on your GitHub account and push your changes to the repository.  Invite @claytonchew and @QMReynold as a collaborator to the repository. Once you have done so, reply us an email with the link to the repository.
